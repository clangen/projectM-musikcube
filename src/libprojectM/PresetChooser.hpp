...
public:
    ...
    std::shared_ptr<Preset> allocate();
...
public:
    ...
    std::shared_ptr<Preset> directoryIndex(std::size_t index) const;
...
inline std::shared_ptr<Preset> PresetIterator::allocate() {
...
inline std::shared_ptr<Preset> PresetChooser::directoryIndex(std::size_t index) const {
