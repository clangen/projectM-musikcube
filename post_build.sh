...
cp build/src/projectM-musikcube/libprojectM_musikcube_plugin.dylib $OUT 2> /dev/null
cp build/src/projectM-musikcube/libprojectM_musikcube_plugin.so $OUT 2> /dev/null
cp build/src/projectM-musikcube/projectM_musikcube $OUT
cp build/src/libprojectM/config.inp "$OUT/projectM/"
